...
CAnimationResource *CResourceManager::GetAnimationResource( const char *sName )
{
	...
	CAnimationResource *pAnimationResource = CreateAnimationResource( sName );
...
CCubemapResource *CResourceManager::GetCubemapResource( const char *sName )
{
	...
	CCubemapResource *pCubemapResource = CreateCubemapResource( sName );
	if (!pCubemapResource)
		return NULL;
...
CGeometryResource *CResourceManager::GetGeometryResource( const char *sName )
{
	...
	CGeometryResource *pGeometryResource = CreateGeometryResource( sName );
	if (!pGeometryResource)
		return NULL;
...
CSkeletonResource *CResourceManager::GetSkeletonResource( const char *sName )
{
	...
	CSkeletonResource *pSkeletonResource = CreateSkeletonResource( sName );
	if (!pSkeletonResource)
		return NULL;
...
CTextureResource *CResourceManager::GetTextureResource( const char *sName )
{
	...
	CTextureResource *pTextureResource = CreateTextureResource( sName );
	if (!pTextureResource)
		return NULL;
