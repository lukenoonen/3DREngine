...
void CreateLevel( void )
{
	...
	CCSMShadowCamera *pCSMShadowCamera = new CCSMShadowCamera( 4.0f, 8.0f, 4.0f, -60.0f, 60.0f, 180.0f, 210.0f, 0.04f, 2048, 0, g_vecZero, glm::radians( glm::vec3( -70.0f, 0.0f, 30.0f ) ), g_vecOne, true, true );
