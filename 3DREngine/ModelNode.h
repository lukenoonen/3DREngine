...
public:
	...
	CModelNode( bool bAssociatedWithBone, unsigned int uiAssociatedBone, const glm::mat4 &matTransformation, const std::vector<unsigned int> &uiMeshes, const std::vector<unsigned int> &uiChildren );
	...
	unsigned int GetMeshesCount( void );
	unsigned int GetMeshes( unsigned int uiIndex );
...
private:
	...
	std::vector<unsigned int> m_uiMeshes;
