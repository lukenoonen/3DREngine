...
CAnimationResource::CAnimationResource( SAnimationResourceData &sData, const char *sName ) : BaseClass( sName )
{
	m_flTime = sData.flTime;
	m_pAnimationChannels = sData.pAnimationChannels;
}
